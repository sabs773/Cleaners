...
<div class="container">  
            <div class="form-group">
                 <form action = "createpdf.php" method="POST" name="add_name" id="add_name">

<center><h1 class="w3-text-grey w3-padding-16"><i class="fa fa-money fa-fw w3-margin-right w3-xxlarge w3-text-teal "></i> Salary Details</h1></center>
...
<input type="text" id="Basic" name="Basic" placeholder = <?php echo $BasicSalary; ?> class = "form-control" readonly></td>
</tr>

<tr>
<!--Nett Salary-->
<td>
<label>Nett Salary (RM)</label>
<input type="text" id="nett" name="net" placeholder = <?php echo $nett; ?> class = "form-control" readonly></td>
</tr>
...
<input type="text" id="epf" name="epf" placeholder = <?php echo $bonus; ?> class = "form-control" readonly></td>
</tr> 
...
<input type="text" id="nett" name="net" placeholder = <?php echo $claim; ?> class = "form-control" readonly></td>
</tr>  
...
<input type="text" id="Socso" name="Socso" placeholder = <?php echo $TotalSocso; ?> class = "form-control" readonly></td>
</tr> 
...
<td>
<label>EPF (RM)</label>
<input type="text" id="epf" name="epf" placeholder = <?php echo $Totalepf; ?> class = "form-control" readonly></td>
</tr> 
...
<center>
<div class="center">
<button type="submit" name="submit"  class="btn btn-success" value="Submit">Print Salary Details</button>
</div></center>
       </div>  
  </form>  
</div>  
