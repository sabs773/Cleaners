...
<body class="main-bg">
    ...
    <div class="login-container text-c animated flipInX">
                <div>
                     <div class="sidenav-header-inner text-center"><img src="img/logo.png" alt="person" class="img-fluid rounded-circle"></span></h1>
                </div>
                    <h3 class="text-whitesmoke">CMS Login</h3>
                    <p class="text-whitesmoke">Sign In</p>
                <div class="container-content">

    <div class="form-group">
    <input type="text" id="username" name="username" class = "form-control" size="50" class="form-control"/>
    </div> 

    <div class="form-group">
    <input type="password" id ="password" name="password" class = "form-control" size="1" min="1" max="100"/>
    </div> 

    <button type="submit" name="submit"  class="btn btn-success" value="Submit">Login</button><br></br>
                  <p class="text-whitesmoke text-center"><small>Do not have an account?</small></p>
                  <a class="text-darkyellow" href="signup.php"><small>Sign Up</small></a>
                      </form>
